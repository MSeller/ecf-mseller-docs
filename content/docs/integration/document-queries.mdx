...
> **Sin webhooks por ahora**: el estado se obtiene consultando el API, y cada consulta consume un request. Prefiere la [consulta en batch](#consulta-en-batch) para varios documentos, deja de consultar un documento al llegar a un estado final (Aceptado o Rechazado) y reutiliza tu token de acceso.
