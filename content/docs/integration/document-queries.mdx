...
<Callout title="En resumen">
  ...
  - Espera unos segundos después del envío y **deja de consultar** cuando el estado sea final (Aceptado, Aceptado Condicional o Rechazado). Si sigue en proceso, vuelve a consultar más tarde.
