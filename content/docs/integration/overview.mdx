...
5. **Anulación de secuencias** - Anular ante la DGII los rangos de e-NCF que no
   llegaron a utilizarse (ver [Anulación de e-NCF](/docs/integration/anulacion-ncf))
...
- Certificado digital válido cargado en la plataforma (requerido en **todos** los ambientes, incluido TesteCF; sin él, el API responde `412 CERTIFICATE_NOT_CONFIGURED`)
