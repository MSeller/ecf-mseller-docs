---
title: "Ejemplos JSON por tipo de e-CF"
seoTitle: "Ejemplos JSON de e-CF por Tipo (E31, E32, E33, E34…)"
description: "Ejemplos completos de JSON para cada tipo de e-CF (31, 32, 33, 34, 41, 43, 44, 45, 46 y 47) usados en las pruebas de certificación DGII."
---
...
Úsalos como plantilla para tu integración: copia el tipo que necesitas y reemplaza los datos. La estructura general está explicada en [Formato JSON](/docs/integration/document-format).
