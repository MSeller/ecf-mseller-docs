---
title: "Formato JSON de e-CF"
seoTitle: "Formato JSON de e-CF: Campos y Especificación"
description: "Cómo estructurar el JSON para emitir e-CF con MSeller ECF según el esquema de la DGII; la plataforma lo convierte a XML y lo firma por ti."
---

Envías cada comprobante como **JSON**. MSeller lo convierte a XML y lo firma por ti.

<Callout title="La regla de oro">
  El JSON usa **los mismos nombres de campo y la misma estructura** que el XML oficial de la DGII. Si sabes qué campo va en el XML, ya sabes cómo va en el JSON.
</Callout>
